...
static int window_lines_ = TERM_LINES;		/* scroll lines set by sigwinch_handler */
static int window_columns_ = TERM_COLS;
static bool sighup_pending = false;
static bool sigint_pending = false;

/* Raman: I don't like f*hups :-) */
...
// Raman: Again, and I don't like f*HUPS :-) */
...
void enable_interrupts( void )
  {
// Raman: Not really helping at this point */
//  if( --mutex <= 0 )
//    {
//    mutex = 0;
